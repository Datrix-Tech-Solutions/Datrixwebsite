        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-4 vibe-rv-l">
              <h3 className="vibe-label">The African Market</h3>
              <p>
                We work across the african business landscape and understand
                how much local context matters — it’s why Workphelo is always
                close by. Wherever in Africa you operate and whoever your
                customers are, Workphelo delivers a hyper-local software
